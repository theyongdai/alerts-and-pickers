...
class ViewController: UIViewController {
    ...
    func show(alert type: AlertType) {
        ...
        case .simple:
            let alert = UIAlertController(title: "Simple Alert", message: "3 kinds of actions", preferredStyle: .alert)
        ...
        case .oneTextField:
            let alert = UIAlertController(title: "TextField", message: "Secure Entry", preferredStyle: .alert)
        ...
        case .pickerView:
            let alert = UIAlertController(title: "Picker View", message: "Preferred Content Height", preferredStyle: .alert)
